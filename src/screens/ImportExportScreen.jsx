...
import { exportToExcel, backupDatabase } from '../utils/excelExport';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDesc}>
          Exporte toutes les données (clients, ventes, paiements, produits...) dans un fichier Excel (.xlsx).
          Partagez via WhatsApp, e-mail, Drive, etc.
        </Text>
        <TouchableOpacity style={styles.btn} onPress={handleExport} disabled={loading}>
          <Text style={styles.btnText}>Exporter en Excel</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDesc}>
          Importe des ventes depuis un fichier Excel (.xlsx) avec les colonnes :{'\n'}
        ...
        <TouchableOpacity style={[styles.btn, styles.btnImport]} onPress={handleImport} disabled={loading}>
          <Text style={styles.btnText}>Importer depuis Excel</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  btn: {
    backgroundColor: '#3498DB', borderRadius: 10, padding: 14,
    alignItems: 'center',
  },
